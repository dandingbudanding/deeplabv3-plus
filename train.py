...
parser.add_argument('--learning_rate_policy', type=str, default='cos',
                    choices=['poly', 'piecewise','cos'],
                    help='Learning rate policy to optimize loss.')

parser.add_argument('--max_iter', type=int, default=250000,
                    help='Number of maximum iteration used for "poly" learning rate policy.')

parser.add_argument('--data_dir', type=str, default=path1+'/data/tfrecord/',
...
parser.add_argument('--pre_trained_model', type=str, default='./resnet_v2_101_2017_04_14/resnet_v2_101.ckpt',
...
parser.add_argument('--initial_learning_rate', type=float, default=2e-4,
                    help='Initial learning rate for the optimizer.')

parser.add_argument('--end_learning_rate', type=float, default=1e-6,
                    help='End learning rate for the optimizer.')

parser.add_argument('--initial_global_step', type=int, default=250000,
...
def get_filenames(is_training, data_dir):
  ...
  """
  if is_training:
    return [os.path.join(data_dir, 'tianchinongye_train_20000.record')]
  else:
    return [os.path.join(data_dir, 'tianchinongye_val_20000.record')]
