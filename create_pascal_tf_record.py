...
parser.add_argument('--data_dir', type=str, default=path1 + '/data',
                    help='Path to the directory containing the PASCAL VOC data.')

parser.add_argument('--output_path', type=str, default=path1 + '/data/tfrecord',
                    help='Path to the directory to create TFRecords outputs.')

parser.add_argument('--train_data_list', type=str, default='./train.csv',
                    help='Path to the file listing the training data.')

parser.add_argument('--valid_data_list', type=str, default='./val.csv',
                    help='Path to the file listing the validation data.')

parser.add_argument('--image_data_dir', type=str,
                    default=path1+'/data/train/src',
                    help='The directory containing the image data.')

parser.add_argument('--label_data_dir', type=str,
                    default=path1+'/data/train/label',
...
def main(unused_argv):
    ...
    image_dir = FLAGS.image_data_dir
    label_dir = FLAGS.label_data_dir
    ...
    train_output_path = os.path.join(FLAGS.output_path, 'tianchinongye_train_20000_sele.record')
    val_output_path = os.path.join(FLAGS.output_path, 'tianchinongye_val_20000_sele.record')
